...
public class StopWatch {
	...
	System.out.println("Program starting time (ms): " + startTime + Color.cyan + " (" + startCOScount + ", " + startCIScount + ")" + Color.black);
    }
	...
	System.out.println("Program stopping time (ms): " + stopTime + Color.cyan + " (" + stopCOScount + ", " + stopCIScount + ")" + Color.black);
    }

    public static void pointTimeStamp(String point) {
	System.out.println("Time (ms) " + point + ": " + getElapsedTime() + Color.cyan + " (" + getOutputCounter() + ", " + getInputCounter() + ")" + Color.black);
    }

    public static void taskTimeStamp(String task) {
	System.out.println("Elapsed time (ms) on " + task + ": " + getSegmentedElapsedTime() + Color.cyan + " (" + getOutputUsage() + ", " + getInputUsage() + ")" + Color.black);
    }
